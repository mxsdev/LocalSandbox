...
import type { EdgeSpecRequest, SerializableToResponse } from "../types/web-handler.js";
export type Middleware<RequiredContext = {}, NewContext = {}, RequestOptions = {}> = (request: EdgeSpecRequest<{
...
export type MiddlewareChain<RequiredOptions = any> = readonly Middleware<RequiredOptions>[];
/**
 ...
 * ```
 */
export type AccumulateMiddlewareChainResultOptions<MiddlewareChain, AccumulationType extends "union" | "intersection"> = MiddlewareChain extends readonly [
 ...
 *
 */
export type MapMiddlewares<MiddlewareMap extends {
