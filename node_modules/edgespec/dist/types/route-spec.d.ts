...
import type { AccumulateMiddlewareChainResultOptions, MiddlewareChain, MapMiddlewares } from "../middleware/types.js";
import type { GetAuthMiddlewaresFromGlobalSpec, GlobalSpec } from "./global-spec.js";
import type { EdgeSpecCustomResponse, EdgeSpecMultiPartFormDataResponse, EdgeSpecJsonResponse, EdgeSpecRouteFn, HTTPMethods, EdgeSpecRouteParams } from "./web-handler.js";
...
export type EdgeSpecRouteFnFromSpecs<GS extends GlobalSpec, RS extends RouteSpec<GetAuthMiddlewaresFromGlobalSpec<GS>>> = EdgeSpecRouteFn<GetMiddlewareRequestOptions<GS, RS>, GetRouteSpecResponseType<GS, RS>, GetMiddlewareRequestContext<GS, RS> & ResponseTypeToContext<GetRouteSpecResponseType<GS, RS>>>;
export type CreateWithRouteSpecFn<GS extends GlobalSpec> = <const RS extends RouteSpec<GetAuthMiddlewaresFromGlobalSpec<GS>>>(routeSpec: RS) => (route: EdgeSpecRouteFnFromSpecs<GS, RS>) => EdgeSpecRouteFn;
export {};
