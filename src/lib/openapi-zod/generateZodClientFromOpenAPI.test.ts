...
beforeAll(async () => {
  openApiDoc = (await SwaggerParser.parse(
    "./tests/petstore.yaml",
  )) as OpenAPIObject
})
        ...
        withAlias: (path: string, method: string, operation) =>
          path === "/pet"
            ...
            : (operation?.operationId ??
              method + pathToVariableName(path || "/noPath")),
      },
    })
    expect(prettyOutput).toMatchInlineSnapshot(`
          "import { makeApi, Zodios, type ZodiosOptions } from "@zodios/core";
        ...
        get: {
          ...
          responses: {
            "200": {
              description: "OK",
              content: {
                "application/json": { schema: schemas["DeeplyNested"] },
              },
            },
          },
        },
        ...
        get: {
          ...
          responses: {
            "200": {
              description: "OK",
              content: {
                "application/json": { schema: schemas["VeryDeeplyNested"] },
              },
            },
          },
        },
